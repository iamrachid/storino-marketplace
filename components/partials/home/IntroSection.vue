	...
	<div class="container intro-section">
		<div class="row">
			<div class="col-xl-9 col-lg-9 col-md-8 mb-4 mb-lg-0">
				<swiper-carousel class="swiper-theme swiper-dot-inner swiper-dot-white intro-slider animation-slider"
					:options="introSlider" v-animate ref="introSlider">
					<div class="intro-slide1 banner banner-fixed swiper-slide" style="background-color: #e8e8ea">
						<figure>
							<img
								src="~/static/images/home/slides/1.jpg"
								alt="banner"
								width="580"
								height="460"/>
						</figure>
                ...
                Shop now
					...
					<div class="intro-slide2 banner banner-fixed swiper-slide" style="background-color: #7a7675">
						<figure>
							<img
								src="~/static/images/home/slides/2.jpg"
								alt="banner"
								width="580"
								height="460"/>
						</figure>
						<div class="banner-content x-50 y-50 text-center">
							<div class="slide-animate" data-animation-options="{'name': 'blurIn', 'duration': '1.5s'}">

								<h4 class="banner-subtitle mb-1 ls-l text-white text-uppercase font-weight-normal">
									Flash Sales
                </h4>
								...
								<nuxt-link
									to="/shop"
									class="btn btn-outline btn-white btn-rounded mb-1"
								>Shop now</nuxt-link>
							</div>
						</div>
					</div>
			...
			<div class="col-xl-3 col-lg-3 col-md-4 mb-4">
				<div class="intro-banner banner banner-fixed overlay-dark">
					<figure>
						<img
							class="x-50"
							src="~/static/images/home/banner/drone.png"
							alt="product"
							width="346"
							height="193"
						/>
              ...
              Through <br/>
              <span class="d-inline-block mt-1 ls-normal">Riode Birthday</span>
						</p>
